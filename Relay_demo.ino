...
int relayDwellTimeMS1 = 500; //variable for setting the dwell time a relay is actuated for
int relayDwellTimeMS2 = 1000; //variable for setting the dwell time a relay is actuated for
int relayDwellTimeMS3 = 1500; //variable for setting the dwell time a relay is actuated for
int relayDwellTimeMS4 = 2000; //variable for setting the dwell time a relay is actuated for
...
delay(relayDwellTimeMS1);                //wait for the dwell time (500 ms)
...
delay(relayDwellTimeMS2);                //wait for the dwell time (1000 ms)
...
delay(relayDwellTimeMS3);                //wait for the dwell time (1500 ms)
...
delay(relayDwellTimeMS4);                //wait for the dwell time (2000 ms)
